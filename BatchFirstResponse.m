function [output] = BatchFirstResponse(foldername,taptime,window, write, tooshort)
...
%window = 1;
%taptime = 300;
%foldername = 'C:\Users\MWT\Desktop\Jeremy\Developmemt\Adult\180306_Adult';
...
for i = 1:length(subfolds)
    subname = [foldername '\' subfolds{i}];
    tempout = FirstResponse(subname, taptime, window, tooshort);
...
if write == 1
    ...
    excelname = [foldername '\' splits{end} '_BatchFirstResponse.xlsx'];
    delete(excelname)
